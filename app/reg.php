          ...
          <div class="row">
            <div class="col-12 col-lg-8 offset-lg-2">
              <form class="reg-form">
                ...
                <div class="reg-form-input-wrapp one-login">
                  <input type="text" class="reg-input" placeholder="Login">
                </div>
                <div class="reg-form-input-wrapp password">
                  <input type="password" class="reg-input" placeholder="•••••••••••••••••••••••">
                </div>
                <div class="reg-form__bottom" style="justify-content: flex-end;">
                  <div class="reg-form__bottom__button">
                    <button class="google">Зарегистрироватся через <span class="icon"></span></button>
                    <button class="enter main-btn">Зарегистрироватся</button>
                  </div>
                </div>
              </form>
              <div class="after-form-reg">Еще нет аккаунта?  <a href="reg.php">Зарегистрироваться</a></div>
            </div>
          </div>
        </div>
      </div>
