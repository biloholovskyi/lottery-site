    ...
    <div class="home__content">
      <div class="container">
        <div class="reg__content">
          <h3 class="reg-title">Вход в систему</h3>
          <div class="row">
            <div class="col-12 col-lg-8 offset-lg-2">
              <form class="reg-form">
                ...
                <div class="reg-form__bottom">
                  <a href="recovery.php" class="reg-form__bottom__link">Забыли пароль?</a>
                  <div class="reg-form__bottom__button">
                    <button class="google">Войти через <span class="icon"></span></button>
                    <button class="enter main-btn">Войти</button>
                  </div>
                </div>
              </form>
